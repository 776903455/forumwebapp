...
<div class="head_title0" style="width: 1366px;height: 150px;background: rgba(0,0,0,0.05)">
    <div class="head_title">
            ...
            <span class="head_title_text">
                <img class="jishufenxiang" src="${pageContext.request.contextPath}/static/img/xuexijingli.jpg">
        ...
        <div class="hot_resource_buttom">
            ...
            <div class="hot_top_buttom_buttom">
                <div class="hot_top_buttom_buttom_left">
                    <ul>
                        <c:forEach items="${articles6}" var="article6">
                            <li style="border-bottom: 1px grey dashed;"><a href="${pageContext.request.contextPath}/selectArtByAid.do?aid=${article6.aid}">${article6.aname}</a></li>
                        </c:forEach>
                ...
                <div class="hot_top_buttom_buttom_rigth">
                    <ul>
                        <c:forEach items="${articles7}" var="article7">
                            <li style="border-bottom: 1px grey dashed;"><a href="${pageContext.request.contextPath}/selectArtByAid.do?aid=${article7.aid}">${article7.aname}</a></li>
                        </c:forEach>
